...
The MORTAR project's [Code of Conduct](CODE_OF_CONDUCT.md) outlines the expected behavior for all contributors and users. 
Please read it before contributing to ensure a welcoming and productive environment for everyone.
