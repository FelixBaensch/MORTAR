...
(click <a href="https://github.com/FelixBaensch/MORTAR/releases/download/v1.2.0.0-beta.2/MORTAR_v1.2.0.0-beta.2_WINx64_installer.exe">here</a> to 
...
located in the MORTAR program folder (default "C:\Program Files\MORTAR\MORTARv1.2.0.0-beta.2\bin" or the path specified at 
...
<p><b>Linux and macOS:</b> Every release has the executable Java ARchive (JAR) "MORTAR-fat-1.2.0.0-beta.2.jar"
attached, which contains the packaged MORTAR code together with all dependencies 
(click <a href="https://github.com/FelixBaensch/MORTAR/releases/download/v1.2.0.0-beta.2/MORTAR-fat-1.2.0.0-beta.2.jar">here</a>
...
```shell
java -jar -Xms512m -Xmx4g <path to>MORTAR-fat-1.2.0.0-beta.2.jar
```
...
For the latter, a special "fat JAR" named "MORTAR-fat-aarch64-1.2.0.0-beta.2.jar" is available from the distributions attached to the releases and must be used 
(click <a href="https://github.com/FelixBaensch/MORTAR/releases/download/v1.2.0.0-beta.2/MORTAR-fat-aarch64-1.2.0.0-beta.2.jar">here</a> to 
